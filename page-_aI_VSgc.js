...
const eh = D.lazy(() => import("./index-DEENlj51.js")), To = D.memo(
  ({
    content: e,
    messageId: t,
    ...n
...
const lh = { VITE_API_BFF_URL: "https://api.pas.app.br/" }, ch = lh;
...
function dh() {
  return "https://api.pas.app.br/assistant-ai/api/v1/threads/stream";
}
